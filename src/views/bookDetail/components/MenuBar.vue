    ...
    <transition name="slide-up">
      <div class="menu-wrapper"
        ...
        <div class="icon-wrapper">
          <span class="iconfont icon icon-category"
            @click="showSetting(3)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="iconfont icon icon-map"
            @click="showSetting(2)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="iconfont icon icon-Daytimemode"
            @click="showSetting(1)"></span>
        </div>
        <div class="icon-wrapper">
          <span class="iconfont icon icon-editor"
  ...
  .setting-progress {
    ...
    .progress-wrapper {
      ...
      .progress {
        ...
        height: px2rem(2);
        background: -moz-linear-gradient(#999, #999) no-repeat, #ddd;
